module.exports = {
	...
	"updated_at": "2018-11-09T08:52:04Z",
	"source_locale": {
	...
	"keys": {
		...
		"recoveryCode_msg": "Bitte nimm dir etwas Zeit um den Wiederherstellungs-Code aufzuschreiben. Dieser kann dazu verwendet werden den Zugang zu deinen Account wiederherzustellen, falls du das Passwort oder den zweiten Faktor verloren hast.",
		...
		"requestApproval_msg": "Du darfst leider gerade keine E-Mails senden oder empfangen (außer an den Tutanota-Support), da dein Account erst freigegeben werden muss, um Missbrauch, wie Spam, zu verhindern. Bitte schreibe uns an approval@tutao.de und beschreibe wozu du diesen E-Mail-Account verwenden möchtest.",
		...
		"defaultMailHandler_msg": "Registriere Tutanota Desktop als das Standard-Mailprogramm, z.B. um mailto Links zu öffnen. Diese Aktion könnte Administratorrechte erfordern.",
